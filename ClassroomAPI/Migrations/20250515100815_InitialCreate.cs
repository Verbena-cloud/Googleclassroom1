        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_UserType", "UserType IN ('Teacher', 'Student', 'Admin')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Assignments_AssignmentType", "AssignmentType IN ('Assignment', 'Quiz', 'Exam', 'Material')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CourseEnrollments_Status", "Status IN ('Active', 'Inactive', 'Pending')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentMaterials", x => x.MaterialID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Submissions_Status", "Status IN ('Draft', 'Submitted', 'Graded', 'Late')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Comments_Target", "([AssignmentID] IS NOT NULL OR [SubmissionID] IS NOT NULL)");
                    table.ForeignKey(
